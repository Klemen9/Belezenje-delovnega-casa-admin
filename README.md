...
Program za beleženje delovnega časa je bil narejen za beleženje delovnega časa zaposlenih na osnovni šoli z uporabo nfc ključkov ali kartic. Program je setavljen iz treh delov programske opreme + SMB shrambe + OneDrive (po potrebi, če se uporablja Aplikacija za zaposlene) , kjer se shranjujeo podatki. Program je bil testiran na 20 zaposlenih.
...
V nastavitvah je potrebno pot SMB shrambe napisati v obliki UNC \\192.168.1.1\backup
